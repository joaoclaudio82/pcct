...
{\LARGE\bfseries Plataforma de Inteligência Artificial para Imagem Espectral Quantitativa em Tomografia por Contagem de Fótons Aplicada à Oncologia e à Neurodegeneração}\\[1.1cm]
...
Casos clínicos iniciais: & câncer de pulmão, metástases hepáticas de câncer colorretal, massas renais e neuroimagem quantitativa de demências (doença de Alzheimer)\\
...
Os casos demonstradores iniciais recomendados são quatro, escolhidos para que cada um explore uma capacidade distinta do PCCT com o mesmo núcleo tecnológico: \textbf{câncer de pulmão} (detecção e caracterização de nódulos em ultra-baixa dose), \textbf{metástases hepáticas de câncer colorretal} (mapas de iodo como biomarcador de perfusão e resposta), \textbf{massas renais} (caracterização não invasiva por decomposição de materiais) e \textbf{neuroimagem quantitativa de demências} (morfometria de atrofia, carga cerebrovascular e rastreamento oportunista de neurodegeneração em TC de crânio, com a doença de Alzheimer como caso central). A arquitetura, entretanto, será projetada como \textbf{órgão-configurável}, para posterior extensão a outros sítios tumorais.
...
\item criar modelos de segmentação de órgãos, lesões e estruturas cerebrais para os quatro demonstradores;
...
\paragraph{Demonstrador 4 -- Neuroimagem quantitativa de demências (doença de Alzheimer).} Frente fora do eixo oncológico que reaproveita o mesmo núcleo tecnológico. Os biomarcadores moleculares de Alzheimer (amiloide e tau) pertencem ao PET e ao líquor, e a microestrutura pertence à RM; o papel do PCCT aqui é outro, e é triplo. Primeiro, \textbf{morfometria de atrofia em TC}: com resolução submilimétrica, ausência de ruído eletrônico e melhor contraste entre substância cinzenta e branca, torna-se viável quantificar em TC medidas hoje restritas à RM, como volume ventricular, fração de líquor, atrofia cortical global e atrofia do lobo temporal medial (escala MTA automatizada), já demonstradas em TC convencional com aprendizado profundo \cite{srikrishna2021,srikrishna2024} e favorecidas pela qualidade de imagem cerebral do detector de contagem de fótons \cite{pourmorteza}. Segundo, \textbf{carga cerebrovascular quantitativa}: leucoaraiose, doença de pequenos vasos e calcificações intracranianas, relevantes na demência mista. Terceiro, \textbf{rastreamento oportunista}: todo TC de crânio de rotina em idosos (queda, trauma, suspeita de AVC) torna-se uma oportunidade de triagem quantitativa de neurodegeneração, sem exame adicional. O posicionamento é de \textbf{triagem, estratificação e acompanhamento longitudinal}, nunca de diagnóstico molecular. No contexto brasileiro, em que a RM é escassa e o PET amiloide é praticamente inexistente na rede pública, a TC de crânio é o exame de neuroimagem mais acessível: uma camada de IA que a transforma em triagem quantitativa de demência tem impacto de saúde pública direto e constitui evidência que os centros europeus e norte-americanos não produzirão por nós.

\begin{caixa}
\simples Os quatro demonstradores foram escolhidos como um ``teste quádruplo'' da mesma plataforma: o pulmão força o limite de dose e resolução; o fígado força o limite da quantificação espectral; o rim força a capacidade de caracterizar tecido; e o cérebro força a morfometria de precisão sem contraste. Se o núcleo funcionar nos quatro, a generalização para outros sítios e outras condições se torna uma extensão natural.
\end{caixa}
...
A segmentação deverá identificar estruturas relevantes para cada demonstrador: pulmões, lobos e nódulos; fígado, segmentos hepáticos e lesões metastáticas; rins, córtex, medula e massas renais; cavidade intracraniana, parênquima, líquor, ventrículos e hipocampo/lobo temporal medial; além de estruturas de referência (aorta, músculo, baço) para normalização de realce. Serão comparadas estratégias como:
...
Morfometria cerebral & erro volumétrico vs. referência em RM quando disponível, ICC, concordância da escala MTA automatizada com leitura de especialista.\\
...
Neurologista / geriatra & definição clínica da frente de demências, escalas visuais de referência, endpoints cognitivos e segurança.\\
...
\item morfometria cerebral em PCCT comparada à RM (volumetria e escala MTA);
\item rastreamento oportunista de neurodegeneração em TC de crânio de rotina.
\end{enumerate}
...
Potencial de: menos radiação e menos contraste por exame; avaliação de resposta mais sensível que critérios puramente dimensionais; menos procedimentos invasivos de caracterização; acompanhamento quantitativo longitudinal; triagem de neurodegeneração sem exame adicional para a população idosa.
...
Potencial de: criar competência regional em IA para imagem espectral; formar recursos humanos em área de alta complexidade; estabelecer base para novos projetos em TC quantitativa; atrair cooperações e ensaios; consolidar um núcleo de pesquisa em oncologia e neurologia computacionais por imagem, com uma frente de demências alinhada às necessidades do SUS.
...
\bibitem{pourmorteza} POURMORTEZA, A. et al. Photon-Counting CT of the Brain: In Vivo Human Results and Image-Quality Assessment. \emph{AJNR American Journal of Neuroradiology}, 2017.

\bibitem{srikrishna2021} SRIKRISHNA, M. et al. Deep learning from MRI-derived labels enables automatic brain tissue classification on human brain CT. \emph{NeuroImage}, v. 244, art. 118606, 2021. Disponível em: \url{https://pubmed.ncbi.nlm.nih.gov/34571160/}.

\bibitem{srikrishna2024} SRIKRISHNA, M. et al. CT-based volumetric measures obtained through deep learning: association with biomarkers of neurodegeneration. \emph{Alzheimer's \& Dementia}, 2024. DOI: \url{https://doi.org/10.1002/alz.13445}.
...
\item demonstradores confirmados (oncológicos e frente de demências);
