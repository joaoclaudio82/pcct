...
def classify_response(
    ...
    values = (
        ...
        baseline_q_mg,
        followup_q_mg,
        complete_threshold_ml,
        partial_q_reduction_pct,
        progression_q_increase_pct,
    )
    ...
    delta_volume = (
        100 * (followup_volume_ml - baseline_volume_ml) / baseline_volume_ml
        if baseline_volume_ml
        else None
    )
